...
if item_choice == "철근":
    ...
    dates = ['25.08', '25.09', '25.10', '25.11', '25.12', '26.01', '26.02', '26.03']
...
with c2:
    ...
    # 막대 그래프 복구 및 검정색 글씨 설정
    fig = px.bar(df, x='날짜', y=label_name, text=label_name)
    fig.update_traces(
        marker_color=['#B0C4DE']*(len(df)-1) + ['#FF8C00'], 
    ...
    fig.update_layout(
        ...
        xaxis=dict(tickfont=dict(size=16, color='#000000'), title=dict(font=dict(color='#000000'), text="날짜")),
...
components.html(f"""
    ...
    .yellow-table {{ min-width: 2800px; border-collapse: collapse; text-align: center; font-family: sans-serif; }}
